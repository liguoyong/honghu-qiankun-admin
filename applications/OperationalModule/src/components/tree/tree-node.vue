<template>
  <div class="el-tree-node" @click.stop="handleClick" @contextmenu="($event) => this.handleContextMenu($event)"
    ...
    <div class="el-tree-node__content" :style="{ 'padding-left': (node.level - 1) * tree.indent + 'px' }">
      ...
      <span class="el-tree-node_select_item" :class="{'is-disabled-checked': node.checked}">
        <el-checkbox class="el-tree-node_checkbox" v-if="showCheckbox" v-model="node.checked" :indeterminate="node.indeterminate"
    ...
    <el-collapse-transition>
      <div class="el-tree-node__children" v-if="!renderAfterExpand || childNodeRendered" v-show="expanded" role="group"
        :aria-expanded="expanded">
        <el-tree-node :render-content="renderContent" v-for="child in node.childNodes"
          :render-after-expand="renderAfterExpand" :show-checkbox="showCheckbox" :key="getNodeKey(child)" :node="child"
...
<style lang="scss">
.shishi-tree .el-tree-node_checkbox.is-disabled.is-checked .el-checkbox__inner {
