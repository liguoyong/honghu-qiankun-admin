<template>
  <div class="wl-transfer transfer" :style="{ width, height }">
    <ComponentTransfer v-bind="$props" ref="wl-transfer-component" @add-btn="handleAddBtn" @remove-btn="handleRemoveBtn"
      @left-check-change="handleLeftCheckChange" @right-check-change="handleRightCheckChange"
      @node-drag-start="handleNodeDragStart" @node-drag-enter="handleNodeDragEnter" @node-drag-leave="handleNodeDragLeave"
      @node-drag-over="handleNodeDragOver" @node-drag-end="handleNodeDragEnd" @node-drop="handleNodeDrop">
