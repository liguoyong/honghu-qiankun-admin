<template>
  <el-dialog :visible="show" title="插入 Word 文档" append-to-body destroy-on-close :close-on-click-modal="false"
    @close="show = false">
    <el-upload drag action="" multiple :auto-upload="false" :on-change="onChange" :on-remove="onRemove"
      style="width:100%;" ref="elUploadRef">
