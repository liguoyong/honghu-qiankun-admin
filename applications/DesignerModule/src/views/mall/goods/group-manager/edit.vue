...
<template>
  <div class="edit">
    <el-dialog :title="type == 'add' ? '新增分组' : '编辑分组'" :visible.sync="show" width="25%">
      <div class="auto-center">
        <el-form :model="form" ref="ruleForm" label-width="120px" class="demo-ruleForm">

          <el-form-item label="级别" prop="level" verify>
            <el-radio v-model="form.level" :label="1" :disabled="type == 'edit'">一级</el-radio>
            <el-radio v-model="form.level" :label="2" :disabled="type == 'edit'">二级</el-radio>
          </el-form-item>

          <el-form-item v-if="form.level == '1'" label="一级分组名称" prop="name" :verify="{ maxLen: 4 }">
            <el-input v-model="form.name" maxlength="4" show-word-limit style="width:150px" size='small'></el-input>
          </el-form-item>

          <template v-if="form.level == '2'">
            <el-form-item label="上级分组" prop="parentType" verify>
              <el-select v-model="form.parentType" placeholder="请选择上级分组" style="width:150px" size='small'
                :disabled="type == 'edit'">
            ...
            <el-form-item label="二级分组名称" prop="name" :verify="{ maxLen: 6 }">
              <el-input v-model="form.name" maxlength="4" show-word-limit style="width:150px" size='small'></el-input>
            </el-form-item>
